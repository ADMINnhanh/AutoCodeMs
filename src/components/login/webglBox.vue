<!--
 * @Description: 登录页面-3d动画渲染  组件
 * @Version: 1.0
 * @Author: xcl
 * @Date: 2022-12-09 10:19:27
 * @LastEditors: xcl
 * @LastEditTime: 2022-12-09 10:39:50
 * @FilePath: \web\src\components\login\webglBox.vue
    ...
    initWebglBox() {
      ...
      function animation() {
        ...
        gsap.to("#graph-left", {
          ...
          repeat: -1,
          yoyo: true,
          ease: "function em(t){return 1===t?1:i*Math.pow(2,-10*t)*Z((t-a)*n)+1}",
          duration: 2,
        });
        ...
        gsap.to("#circle-l", {
          ...
          repeat: -1,
          yoyo: true,
          ease: "function Dm(t){return t<F?E*t*t:t<.7272727272727273?E*Math.pow(t-1.5/2.75,2)+.75:t<.9090909090909092?E*(t-=2.25/2.75)*t+.9375:E*Math.pow(t-2.625/2.75,2)+.984375}",
          duration: 1,
        });
        ...
        gsap.to("#circle-r", {
          ...
          repeat: -1,
          yoyo: true,
          ease: "function config(t,e){void 0===t&&(t=1);var r=1/t,i=t+(e?0:1),n=e?1:0;return function(t){return((i*bt(0,.99999999,t)|0)+n)*r}}",
          duration: 3,
        });
      ...
      function init() {
        ...
        let sprite = new THREE.TextureLoader().load(
          "../assets/images/login/circle-05.png"
        );
...
.webglBox {
  ...
  height: 100%;
  overflow: hidden;
  // background: url("../../assets/images/login/10.jpg") no-repeat center center;
