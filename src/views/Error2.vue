<!--
 * @Author: xcl
 * @Date: 2022-04-20 18:05:05
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2022-10-31 11:06:41
 * @Description: 报错
-->
<template>
  <div id="error">
    ...
    <div class="container">
      <div class="left-section">
        <div class="inner-content">
          <h1 class="heading">
            {{ $route.query.code ? $route.query.code : "Error" }}
          </h1>
          ...
          <div class="dowebok">
            <a @click.prevent.stop="$router.back()">返回</a>
            <a @click.prevent.stop="toLogin()">前往登录</a>
          </div>
        </div>
      </div>
